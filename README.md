...
Hello dear reader! this shell intends to be a minimal unix shell with simple and readible code.
...
| Feature                    | State           |
| -------------------------- | --------------- |
| Tokenization               | Only via spaces and tabs |
...
atleast we got a proper README now.
